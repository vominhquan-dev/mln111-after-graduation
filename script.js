const scenes = [
  {
    ...
    description: "Mình từng nghĩ… sau khi tốt nghiệp, mọi thứ sẽ dễ dàng hơn. Có công việc tốt. Có tiền. Có một cuộc sống ổn định như mình từng tưởng tượng.",
    dropCount: 3,
    fragments: [
    ...
    memory: "Sân trường đại học, ngày tốt nghiệp. Mình nhận bằng cấp với tay run run, chụp ảnh kỷ niệm cùng gia đình. Bạn bè cười vui vẻ, tung nón cao lên trời. Lúc đó mình nghĩ mọi thứ sẽ suôn sẻ, tương lai sáng rõ phía trước.",
...

  {
    ...
    description: "Nhưng hóa ra… Tốt nghiệp chỉ là bắt đầu của một áp lực khác. Không ai còn hỏi mình được bao nhiêu điểm. Người ta bắt đầu hỏi: 'Khi nào có việc?' 'Lương bao nhiêu?' 'Ổn định chưa?'",
    dropCount: 3,
    fragments: [
    ...
    memory: "Phòng trọ buổi đêm. Mình ngồi trước laptop chỉnh CV, gửi đơn xin việc liên tục. Chuông email rơi lần lượt: 'We regret to inform you…' Lúc 2 giờ sáng, mình nằm nhìn lên trần nhà, tự hỏi liệu mình có thực sự đủ khả năng không.",
...

  {
    ...
    description: "Mình muốn theo đuổi điều mình thích. Nhưng mình cũng cần tiền. Mình muốn nghỉ ngơi. Nhưng deadline vẫn tới mỗi ngày. Mình muốn trưởng thành. Nhưng lại sợ thất bại.",
    dropCount: 3,
    fragments: [
    ...
    memory: "Mạng xã hội full tin vui của bạn bè: 'Mình vừa được tuyển!', 'Công ty thứ 2 rồi!', 'Lương tốt lắm!'. Mình ngồi một mình ở quán cafe, cầm điện thoại rồi bỏ. Mẹ gọi hỏi 'Con tính khi nào đi làm chính thức?' Mình chỉ biết đáp 'Dạ… con vẫn đang tìm.'",
...

  {
    ...
    description: "Có những ngày mình cảm thấy bản thân thật vô dụng. Mình bắt đầu nghi ngờ: Liệu mình có thật sự phù hợp với công việc này không?",
    dropCount: 3,
    fragments: [
    ...
    memory: "Công ty thực tập. Mình ngồi trước màn hình, làm task xong lại bị sửa. Deadline tối nay, nhưng task chưa hoàn thành. Ăn mì gói lúc nửa đêm, mắt mệt, lưng đau. Nhìn vào gương, mình thấy một phiên bản khác của chính mình mà không có gì tự hào.",
...

  {
    ...
    description: "Mọi thứ không thay đổi ngay lập tức. Nhưng từng lần thất bại… Từng áp lực nhỏ… Từng trải nghiệm nhỏ… Đang khiến mình thay đổi từng ngày.",
    dropCount: 3,
    fragments: [
    ...
    memory: "Những ngày đi qua, mình dần chuyên tâm hơn. Mở notebook học thêm kỹ năng mới, dậy sớm hơn, đi bộ buổi sáng. Chủ động trao đổi với đồng nghiệp, hỏi từng câu hỏi. Từng lần thất bại trở thành bài học. Từng áp lực nhỏ khiến mình mạnh mẽ hơn từng ngày.",
    hint: "💡 Gợi ý: Sắp xếp các hành động tích cực: học notebook → dậy sớm đi bộ → trao đổi với đồng nghiệp."
  },

  {
    title: "Cảnh 6 — Trưởng Thành",
    description: "Mình không còn là phiên bản trước đây nữa. Nhưng cũng không đánh mất chính mình. Có lẽ trưởng thành… Không phải là trở nên hoàn hảo. Mà là học cách bước tiếp dù cuộc sống không như mong đợi.",
    dropCount: 3,
    fragments: [
    ...
    memory: "Hôm nay, mình ngồi ở cafe với những người bạn cũ. Nhìn lại ảnh tốt nghiệp trên điện thoại, mình cười nhẹ. Mình đã thay đổi, nhưng chưa hoàn toàn mất đi bản thân. Hoàng hôn chiếu vàng qua cửa kính, mình nhận ra: trưởng thành không phải là trở nên hoàn hảo, mà là biết cách sống với những không hoàn hảo đó.",
...
const questions = [
  {
    situation: "Minh từng nghĩ sau khi tốt nghiệp sẽ nhanh chóng có việc làm ổn định. Nhưng sau nhiều lần gửi CV và nhận email từ chối, Minh bắt đầu cảm thấy áp lực và thất vọng.",
    question: "Tình huống trên thể hiện nội dung triết học nào?",
    options: [
      { text: "Quy luật lượng đổi dẫn đến chất đổi", correct: false },
      { text: "Sự đấu tranh giữa kỳ vọng và hiện thực trong mâu thuẫn biện chứng", correct: true },
      { text: "Phủ định sạch trơn quá khứ", correct: false },
      { text: "Vật chất không vận động", correct: false }
    ]
  },
  {
    situation: "Những ngày đi qua, Minh dần chuyên tâm hơn. Mở notebook học thêm kỹ năng mới, dậy sớm hơn, đi bộ buổi sáng. Chủ động trao đổi với đồng nghiệp.",
...
document.getElementById("checkBtn").addEventListener("click", () => {
  ...
  if (correct) {
    ...
    if (currentScene === scenes.length - 1) {
      document.getElementById("checkBtn").innerText = "📚 Xem lại toàn bộ ký ức";
    } else {
